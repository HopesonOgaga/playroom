          ...
          <>
            ...
            >
              ...
              <ul className="flex flex-col gap-6 text-lg">
                <li className="hover:text-emerald-400 transition-colors">dashboard</li>
                <li className="hover:text-emerald-400 transition-colors">tournament</li>
                <li className="hover:text-emerald-400 transition-colors">challenges</li>
              </ul>
